                ...
                <ul class="text-gray-700 list-disc list-inside">
                    @foreach($horaires as $jour => $horaire)
                        <li>
                            ...
                            <strong style="color: {{$carte->couleur2}};"> {{$jours[$jour] ?? 'Jour inconnu' }} :</strong>
    ...
    <div class="flex-cols">
        ...
        <div id="photoGallery"
            ...
            <div class="relative bg-white p-6 rounded-lg w-11/12 md:w-2/3 lg:w-1/2">
                ...
                <button onclick="closeGallery()" class="absolute top-2 right-2 p-2  font-bold text-xl" style="color: {{$carte->couleur2}};">
                    &times;
                </button>
