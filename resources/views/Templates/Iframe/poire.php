...
<div class="max-w-sm rounded-lg overflow-hidden shadow-lg bg-gradient-to-r from-purple-400 via-pink-500 to-red-500 text-white p-6">
    ...
    <p class="text-blue text-base">Titre</p>
    <p class="text-blue text-base">Téléphone</p>
    <p class="text-blue text-base">Ville</p>
    <p class="text-blue text-base">Description</p>
    <p class="text-blue text-base">email@example.com</p>
    ...
    <div class="mt-4">
        ...
        <ul class="mt-2">
            <li class="text-blue">2023-01-01</li>
            <li class="text-blue">2023-02-01</li>
            <li class="text-blue">2023-03-01</li>
        </ul>
    </div>
</div>
</body>
