...
<div class="flex flex-col md:flex-row">
    ...
    <div class="flex-1 md:ml-24 content"> <!-- Adjusted margin-left to match the new menu width -->
        <div class="min-h-screen p-4">
            ...
            <form action="{{ route('employe.modifier.post', $employe->idEmp) }}" method="POST"
                ...
                <div class="mb-4">
                    ...
                    <input type="email" id="email" name="email" value="{{ $employe->mail }}"
                           class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
                <div class="mb-4">
                    <label for="tel" class="block text-gray-700 text-sm font-bold mb-2">Téléphone:</label>
                    <input type="text" id="tel" name="tel" value="{{ $employe->telephone }}"
                           class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
                <div class="mb-4">
                    <label for="fonction" class="block text-gray-700 text-sm font-bold mb-2">Fonction:</label>
                    <input type="text" id="fonction" name="fonction" value="{{ $employe->fonction }}"
                           class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                </div>
