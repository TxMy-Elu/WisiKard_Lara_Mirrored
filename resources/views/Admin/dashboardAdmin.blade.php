                        ...
                        <div class="flex justify-between">
                            ...
                            <div class="flex flex-col">
                                ...
                                <div class="flex justify-end">
                                    <a href="{{ route('regenerateManifest', $entreprise->idCompte) }}" class="ml-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#000" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-file-text mr-2">
