        ...
        <div class="flex flex-wrap -mx-4">
            ...
            <div class="flex flex-col w-[400px] bg-white rounded-lg shadow-lg mx-auto p-4">
                ...
                <form action="{{ route('dashboardClientColor') }}" method="POST"
                    ...
                    <button type="submit" class="bg-indigo-500 text-white px-4 py-2 rounded-full w-[325px]">
                        Enregistrer
                    </button>
                </form>

                <div class="flex justify-center items-center text-center bg-white rounded-lg shadow-lg mx-auto my-2 w-[325px] p-2 mt-4 border border-gray-1200">
