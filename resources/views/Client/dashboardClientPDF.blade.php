                ...
                <div class="grid grid-cols-1 md:grid-cols-7 gap-4">
                    <div class="bg-white p-8 rounded-lg shadow-md relative">
                        <div class="text-center mb-2">
                            @if(File::exists(public_path("entreprises/{$idCompte}_{$carte->nomEntreprise}/logos/logo.jpg")))
                                <img src="{{ asset("entreprises/{$idCompte}_{$carte->nomEntreprise}/logos/logo.jpg") }}" alt="Logo" class="w-24 h-24 mx-auto max-w-xs max-h-xs">
                            @elseif(File::exists(public_path("entreprises/{$idCompte}_{$carte->nomEntreprise}/logos/logo.jpeg")))
                                <img src="{{ asset("entreprises/{$idCompte}_{$carte->nomEntreprise}/logos/logo.jpeg") }}" alt="Logo" class="w-24 h-24 mx-auto max-w-xs max-h-xs">
                            @elseif(File::exists(public_path("entreprises/{$idCompte}_{$carte->nomEntreprise}/logos/logo.png")))
                                <img src="{{ asset("entreprises/{$idCompte}_{$carte->nomEntreprise}/logos/logo.png") }}" alt="Logo" class="w-24 h-24 mx-auto max-w-xs max-h-xs">
                            @endif
                        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-7 gap-4">
                    @foreach(File::files(public_path("entreprises/{$idCompte}_{$carte->nomEntreprise}/images")) as $file)
                        <div class="bg-white p-4 rounded-lg shadow-md relative">
                            ...
                            <img src="{{ asset("entreprises/{$idCompte}_{$carte->nomEntreprise}/images/" . $file->getFilename()) }}" alt="{{ $file->getFilename() }}" class="w-24 h-24 mx-auto max-w-xs max-h-xs">
