...
class Profil extends Controller
{
    public function afficherPageProfil() {
		...
		$dateInscription = Log::where("idCompte", $infosAuth["sub"])->where("typeActionLog", "Inscription")->first()->dateHeureLog;
		$dateDerniereConnexion = Log::where("idCompte", $infosAuth["sub"])->where("typeActionLog", "Connexion réussie")->orderBy('dateHeureLog', 'desc')->first()->dateHeureLog;
