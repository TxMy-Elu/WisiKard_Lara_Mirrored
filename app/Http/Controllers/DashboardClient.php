...
public
function ajoutEmployer(Request $request)
{
    $request->validate([
...
public
function afficherFormulaireModifEmpl($id)
{
...
public
function modifierEmploye(Request $request, $id)
{
    $request->validate([
        'nom' => 'required|string|max:255',
        'prenom' => 'required|string|max:255',
...
public
function afficherDashboardClientPDF()
{
    $idCompte = session('connexion');
