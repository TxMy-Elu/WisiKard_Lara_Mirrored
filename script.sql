...
(10, 1, 3, 'Cette option vous permet de modifier les éléments textuels principaux de votre carte. Vous pouvez ajuster votre titre pour qu\'il soit plus accrocheur et adapter votre description pour mieux présenter votre activité.'),
                                                               (11, 2, 3, '1. Cliquez sur le bouton "Montrer" ci-dessous.'),
...
(35, 1, 11, 'Cette fonction affiche les statistiques individuelles de consultation pour chaque employé. Elle permet de suivre la performance de chaque membre de l\'équipe à travers le nombre de scans de leurs QR Codes personnels. Si aucune donnée n\'est visible, ce'),
...
(46, 1, 16, 'Cette fonction offre une gestion flexible de la visibilité de vos réseaux sociaux : Pour l\'activation : la case cochée en bleu rend le réseau social visible sur votre profil. Pour la désactivation : la case décochée en gris masque temporairement le r'),
(47, 1, 17, 'Cette option permet d\'ajouter des réseaux sociaux qui ne sont pas listés par défaut. C\'est particulièrement utile pour les réseaux sociaux moins courants ou spécifiques à votre secteur d\'activité.'),
    ...
    (51, 1, 18, 'Cette fonction offre une recherche flexible et multiparamètres des employés. Vous pouvez retrouver rapidement un employé en utilisant différents critères (nom, prénom, fonction, numéro de téléphone ou email) via la barre de recherche. C\'est particuli'),
